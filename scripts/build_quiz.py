...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .ring .lab{ position:absolute; inset:0; }
  .ring .lab b{ position:absolute; inset:0; display:grid; place-items:center; font-size:1.4rem; font-weight:800; line-height:1; }
  .ring .lab span{ position:absolute; left:0; right:0; bottom:27px; text-align:center; font-size:.62rem; color:var(--mut); line-height:1; }
